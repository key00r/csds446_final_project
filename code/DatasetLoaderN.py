...
class DatasetLoader(dataset):
    ...
    load_all_tag = False
    compute_s = False
    use_rope = True  # Add this flag to enable RoPE
    ...
    def load_hop_wl_batch(self):
        ...
        # Load shortest path distances for RoPE, if available
        shortest_paths = None
        if self.use_rope:
            try:
    ...
    def load(self):
        ...
        if self.load_all_tag:
            ...
            position_ids_list = []
            hop_ids_list = []
            rope_distances_list = []  # New list for RoPE distances
            ...
            for node in idx:
                ...
                hop_ids = [0]
                rope_distances = [0]  # Distance to self is 0
                ...
                for neighbor, intimacy_score in neighbors_list:
                    ...
                    # Add shortest path distance for RoPE
                    if shortest_paths and node in shortest_paths and neighbor in shortest_paths[node]:
                        ...
                        rope_distances.append(99)  # Use a large value for unreachable nodes
        ...
        return {
            ...
            'rope_distances': rope_distances,  # New field for RoPE
            'y': labels,
            'idx': idx,
            'idx_train': idx_train,
            'idx_test': idx_test,
