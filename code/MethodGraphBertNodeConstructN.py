...
class MethodGraphBertNodeConstruct(BertPreTrainedModel):
    ...
    def forward(self, raw_features, wl_role_ids, init_pos_ids, hop_dis_ids, rope_distances=None, idx=None):
        outputs = self.bert(
            raw_features,
            wl_role_ids,
            init_pos_ids,
    ...
    def train_model(self, max_epoch):
        ...
        for epoch in range(max_epoch):
            ...
            output = self.forward(self.data['raw_embeddings'], self.data['wl_embedding'], self.data['int_embeddings'], self.data['hop_embeddings'],rope_distances=self.data.get('rope_distances') )
